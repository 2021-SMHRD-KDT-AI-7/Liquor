...
public class MyRecipeDTO {
	...
	private String my_ingredient_mixing; // 나의 비법
	...
	public String getMy_ingredient_mixing() {
		return my_ingredient_mixing;
	}

	public void setMy_ingredient_mixing(String my_ingredient_mixing) {
		this.my_ingredient_mixing = my_ingredient_mixing;
	}
