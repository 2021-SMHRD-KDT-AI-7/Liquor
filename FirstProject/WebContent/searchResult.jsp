...
<head>
	...
	<style>
		* {margin: 0; padding: 0;}
		...
		article {width: 100%; height: 300px; background-color: rgba(18, 18, 18, 1);}
		section {overflow: hidden; padding: 5%; width: 90%; background-color: rgba(18, 18, 18, 1);}
		section > div {width: 18%; margin: 1%; height: 170px; background-color: #2c2c2c6d; float: left; border-radius: 5px;}
...
%>	
	<div id="wrap">
		...
		<article>
			<br>
			<div id="div_search">
				<a href="http://localhost:8081/FirstProject/LoadRecipeServiceCon?seq=<%=seqs.get(0)%>">
				<div><img src="<%=imgs.get(0) %>" alt="이미지" id="search"></div></a>
				<br>
		...
		<%for(int i=0;i<seqs.size();i++){%>
			...
			<div><img id="section_search" src="<%=imgs.get(i) %>" alt="이미지"></a>
