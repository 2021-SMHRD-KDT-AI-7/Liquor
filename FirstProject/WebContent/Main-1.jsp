...
<body class="wrap">
	...
	<header>
		<!-- 메뉴창 -->
		<div class="container">
			<a href="Menu.jsp" class="slide-open" id="slide-open"> <span
				class="burgur" style="left: 35px" id="burgur"> <span
					class="top-line"></span> <span class="bot-line"></span></a> <a
				href="Search-1.jsp"><img class="seach" src="./img_ex/search.png"
				alt="돋보기 이미지"></a> </span>
...
<body>
	...
	<div class="body_2">
		...
		<div class="slider">
			<div>
				<h1 class="reco_text">여름에 어울리는</h1>
				<a href="cock_Reco.jsp?opinion=여름"><img src="./imgs/12.png"
					alt="이미지1"></a>
			</div>
			<div>
				<h1 class="reco_text">여자들이 좋아하는</h1>
				<a href="cock_Reco.jsp?opinion=여자"><img src="./imgs/2.png"
					alt="이미지2"></a>
			</div>
			<div>
				<h1 class="reco_text">할로윈에 어울리는</h1>
				<a href="cock_Reco.jsp?opinion=할로윈"><img src="./imgs/19.png"
					alt="이미지3"></a>
			</div>
			<div>
				<h1 class="reco_text">파티에 어울리는</h1>
				<a href="cock_Reco.jsp?opinion=파티"><img src="./imgs/3.png"
					alt="이미지4"></a>
			</div>
		</div>
		<!-- //이미지 슬라이드 -->
...
%>
	...
	<div class="body_3">
		<div class="slider">
			...
			<div>
				<a
					href="http://210.223.239.217:8081/FirstProject/LoadRecipeServiceCon?seq=<%=dto_list.get(i).getCocktail_seq()%>">
	...
	<div class="body_1">
		<div></div>
		<div class="body_bd">
			<a href="LoadMyRecipeListCon"><p id="body_text">나만의 레시피</p></a>
		</div>
	</div>
