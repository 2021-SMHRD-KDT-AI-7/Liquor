...
<body class="wrap">
    ...
    <body>
        ...
        <div class="body_2">
            <!-- 이미지 슬라이드 -->
            <div class="slider">
                <div><h1>여름에 어울리는</h1><img src="./imgs/진토닉.png" alt="이미지1"></div>
                <div><h1>여자들이 좋아하는</h1><img src="./imgs/모히또.png" alt="이미지2"></div>
                <div><h1>할로윈에 어울리는</h1><img src="./imgs/준벅.png" alt="이미지3"></div>
                <div><h1>파티에 어울리는</h1><img src="./imgs/파나콜라다.png" alt="이미지4"></div>
            </div>
            <!-- //이미지 슬라이드 -->
